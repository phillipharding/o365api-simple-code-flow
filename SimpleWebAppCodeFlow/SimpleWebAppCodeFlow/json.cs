...
using System;
namespace SimpleWebAppCodeFlow
{
   public class SpListJsonCollection
   {
      [JsonProperty(PropertyName = "d")]
      public SpListJsonCollectionResponse d { get; set; }
   }

   public class SpListJsonSingle
   {
      [JsonProperty(PropertyName = "d")]
      public SpListJson d { get; set; }
   }

   public class SpListJsonCollectionResponse
   {
      [JsonProperty(PropertyName = "results")]
      public SpListJson[] results { get; set; }
   }

   public class SpListJson
   {
